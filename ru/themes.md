...
**js** и **css** - Aссеты, которые будут загружаться на всех страницах сайта. Если их прописать здесь, а не прямо в шаблоне, то будет возможным использование сжимателя и склейщика ассетов, а так же удаление их в дочерних темах.
